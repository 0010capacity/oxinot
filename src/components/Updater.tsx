...
import { Modal, Button, Text, Stack, Progress, Group, Alert } from '@mantine/core';
...
export function Updater() {
  ...
  return (
    <>
      ...
      >
        <Stack gap="md">
          ...
          {!error && (
            <>
              <Text size="sm">
                A new version <Text span fw={600}>{updateVersion}</Text> is available.
              </Text>
              ...
              {!isDownloading && (
                <Group justify="flex-end" mt="md">
                  ...
                  <Button onClick={installUpdate} leftSection={<IconDownload size={16} />}>
      ...
      <div style={{ display: 'none' }} data-updater-manual-check onClick={handleManualCheck} />
    </>
  );
}
