...
- e5df7c7: - enhance AI provider and model management
...
- 7a7c508: - enhance AI provider and model management
  - add markdown-to-blocks conversion guide and fix TypeScript type error
  - implement Phase 1 - standardize ID parameter naming across tools
  - implement Phases 2-5 - Complete tool parameter standardization
  - resolve remaining lint errors in OpenAIProvider
  ...
  - normalize indentation for AI markdown
  - check for changesets before running action
- 257ee5d: - enhance AI provider and model management
  - add markdown-to-blocks conversion guide and fix TypeScript type error
  - implement Phase 1 - standardize ID parameter naming across tools
  - implement Phases 2-5 - Complete tool parameter standardization
  - resolve remaining lint errors in OpenAIProvider
  ...
  - normalize indentation for AI markdown
  - check for changesets before running action
- b105b97: - enhance AI provider and model management
  - add markdown-to-blocks conversion guide and fix TypeScript type error
  - implement Phase 1 - standardize ID parameter naming across tools
  - implement Phases 2-5 - Complete tool parameter standardization
  - resolve remaining lint errors in OpenAIProvider
  ...
  - resolve TypeScript and linting errors for Phase 2
  - normalize indentation for AI markdown
- 5ae9a0b: - enhance AI provider and model management
  - add markdown-to-blocks conversion guide and fix TypeScript type error
  - implement Phase 1 - standardize ID parameter naming across tools
  - implement Phases 2-5 - Complete tool parameter standardization
  - resolve remaining lint errors in OpenAIProvider
...
- 1f1989d: - implement macOS window hide on close instead of app exit
  ...
  - update help modal with latest features and i18n support
  - enhance Physics section layout and node visibility
  - remove unused Divider import
  - resolve all lint errors in HelpModal

### Patch Changes

- 1f1989d: - update CSP to allow Firebase and analytics
  - update CSP to allow Firebase and analytics (#483)
...
- 30daa42: - implement macOS window hide on close instead of app exit
  - implement Firebase Analytics telemetry integration (#473)
  - expand command palette with block and workspace operations
  - focus input field on CommandPalette and SearchModal open
  - use useDidUpdate hook to ensure input focus on modal open
...
- 9561bc4: - implement macOS window hide on close instead of app exit
- a415890: - implement macOS window hide on close instead of app exit
